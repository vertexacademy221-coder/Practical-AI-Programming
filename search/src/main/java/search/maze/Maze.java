...
/**
 * Class Maze - class for representing seach space as a two-Locational maze
 * 
 */
...
public class Maze
{
	...
	/**
	 * The maze (or seach space) data is stored as a short integer rather than
	...
	public Maze(int width, int height)
	{
		...
		// Fulfill two-locational with zero
		...
		/**
		 * Randomize the maze by putting up arbitrary obsticals
		 */
